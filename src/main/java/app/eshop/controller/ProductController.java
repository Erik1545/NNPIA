...
public class ProductController {
    ...
    @GetMapping
    public List<ServerProductDTO> getAllProducts(@RequestParam(defaultValue = "0") Integer pageNumber, @RequestParam(defaultValue = "4") Integer pageSize, @RequestParam(defaultValue = "id") String sortBy) {
